...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <h1 className='font-poppins text-white font-semibold ss:text-[68px] text-[52px] ss:leading-[100.8px] leading-[75px] w-full'>Payment Method</h1>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className='absolute z-[1] w-[80%] h-[85%] rounded-full white__gradient bottom-40' />
